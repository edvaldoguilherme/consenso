document.addEventListener('DOMContentLoaded', () => {
    ...
    if (i == 1) {
        creatDiv(cliente,data,hora,id1)
        creatDiv(cliente, data, hora,id2)
    }

})


function creatDiv(cliente,dia,hora,id) {
    ...
    const texto3 = document.createTextNode("Cliente: ")
    const textocliente = document.createTextNode(cliente)
    ...
    paragrafo3.appendChild(textocliente)
